...
_TASK_NAMES: dict[str, str] = {
    ...
    # Pravki-bug-fixes §Z-21 (Item 8): personal you_were_caught event в user-stream
    # violator'а. event_type='caught' (COLLISION-фикс из Item 6:
    # 'sse_published:caught:{m}:{d}' — независимый namespace от checkin).
    # Отдельный try/except в catch_violator от publish_catch_event — независимые попытки.
