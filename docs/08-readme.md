...
> Snapshot от 2026-07-22. **VPS-секция ниже устарела** — реальный сервер Contabo (Германия),
> не Selectel (РФ). Точные параметры прод-сервера — в [09-prod-readiness.md](09-prod-readiness.md) §1
> и [10-deploy.md](10-deploy.md) §1-2. Эта секция осталась как **целевая архитектура**,
> актуальная для первого развёртывания нового dev-окружения.
...
> ⚠️ Эта секция — **целевая** конфигурация для dev-окружения. Текущий прод
> (Contabo VPS 4, 4 vCPU / 8 GB / 100 GB SSD, `169.58.52.78`) больше по ресурсам,
> см. [09-prod-readiness.md](09-prod-readiness.md) §1 и [10-deploy.md](10-deploy.md).
...
| Диск | 40 ГБ NVMe SSD |
| Сеть | 1 Гбит/с (целевой RU-регион, Selectel; текущий — Германия) |
